...
export const useEntregaService = () => {
    ...
    const getEntregas = async () => {
        try {
            ...
            throw new Error('No se pudieron obtener las entregas. Inténtalo de nuevo más tarde.');
        }
    }
    ...
    const getPendientes = async () => {
        try {
            ...
            throw new Error('No se pudieron obtener las entregas pendientes. Inténtalo de nuevo más tarde.');
        }
    }
    ...
    const getEntregaById = async (id) => {
        try {
            ...
            throw new Error('No se pudo obtener la entrega. Inténtalo de nuevo más tarde.');
        }
    }
